...
class Test(olivia.Channels_controls):
...
view = Test()
surface = cairo.ImageSurface(cairo.FORMAT_ARGB32, 1300, 2200)
cr = cairo.Context(surface)

def q():
    view._draw_broken_bar(cr, False, 89, 13, 589, (0.8, 0.2, 0.9, 1))

print(timeit.timeit("q()", number=3500, setup="from __main__ import q"))
